...
function passlist()
{
var url = "https://stittlist.github.io/index.html?list="+ shoppinglist;   //replace YOURGITHUBURL with your Github repo URL example: Konkollist.github.io
...
var btnsharelist = '<input class="button" id="shares" name="shares" type="submit" value="Share Movie List" onclick="share()" />';
...
if (arrayLength > 0)
{
  document.getElementById("labels").innerHTML = 'Watched Movies';
